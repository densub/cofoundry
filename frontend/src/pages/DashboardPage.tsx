...
export default function DashboardPage() {
  ...
  return (
    <div className="h-[calc(100vh-56px)] flex flex-col bg-space-900">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 px-3 sm:px-5 py-2.5 border-b border-white/10 bg-space-800/60">
        ...
        <div className="flex items-center gap-2 overflow-x-auto">
          ...
          <Link
            to="/integrations"
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-brand-600 hover:bg-brand-500 text-sm font-medium transition-colors whitespace-nowrap"
          >
