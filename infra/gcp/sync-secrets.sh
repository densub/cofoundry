...
upsert_secret VITE_SUPABASE_URL "${VITE_SUPABASE_URL:-}"
upsert_secret VITE_SUPABASE_ANON_KEY "${VITE_SUPABASE_ANON_KEY:-}"
...
upsert_secret GITHUB_CLIENT_ID "${GITHUB_CLIENT_ID:-}"
upsert_secret GITHUB_CLIENT_SECRET "${GITHUB_CLIENT_SECRET:-}"
